    ...
    <ul class="thumbnails gallery" id="imageModel">
        ...
        <li  style="float: left; list-style: none; padding: 0px 5px; margin: 0px 5px; height: 100px; margin-bottom: 50px;" for="<%= i %>">
            <a style="cursor:pointer" >
                <img style="height: 100px;max-width: 500px;"  src="<%= this.imageId %>" class="grayscale thumbnail" title="image <%= i %>" alt="Image<%= i %>">
                <div align="center" title="Delete this image" onclick="image.deleteImage('<%= this.id %>', '<%= i%>')">
