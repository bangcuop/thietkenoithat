            ...
            <form method="GET" action="#contact/grid" id="search" class="form row" >
                <div class="col-sm-3 padding-right-5">
                    <div class="input-group">
                        <input data-search="createTimeFrom" name="createTimeFrom" type="hidden" class="form-control" placeholder="Thời gian liên hệ từ" >
                ...
                <div class="col-sm-3 padding-right-5">
                    <div class="input-group">
                        <input data-search="createTimeTo" name="createTimeTo" type="hidden" class="form-control" placeholder="Thời gian liên hệ đến" >
                        <span class="input-group-addon">
                            <span class="glyphicon glyphicon-calendar"></span>
                        </span>
                    </div>
